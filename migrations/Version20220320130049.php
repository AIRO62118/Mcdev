 ...
 */
final class Version20220320130049 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entreprise (id INT AUTO_INCREMENT NOT NULL, nom_entreprise VARCHAR(255) NOT NULL, logo_entreprise VARCHAR(255) DEFAULT NULL, banniere_entreprise VARCHAR(255) DEFAULT NULL, description_entreprise LONGTEXT DEFAULT NULL, adresse_ville_e VARCHAR(255) NOT NULL, adresse_region_e VARCHAR(255) NOT NULL, adresse_cpe VARCHAR(255) NOT NULL, est_premium TINYINT(1) DEFAULT NULL, date_création_page DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE statistique_perso DROP FOREIGN KEY FK_185528C6A76ED395');
